              ...
              {jobs.map((val, i) => {
                 return (
                          <TableRow  key={i}>
                              ...
                              <TableCell><Button size='small' variant='contained' onClick={() => {delValue(val._id); }}>Update</Button></TableCell>
                              <TableCell><Button size='small' variant='contained'  onClick={() => {updateValue(val); }}>Delete</Button></TableCell>
                          </TableRow>
                             );
                            })}
              </TableBody>
